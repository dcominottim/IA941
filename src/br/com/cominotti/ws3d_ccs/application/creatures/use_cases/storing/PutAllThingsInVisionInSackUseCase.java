...
public class PutAllThingsInVisionInSackUseCase implements RunnableUseCase<PutAllThingsInVisionInSackUseCaseInput, EmptyReturn> {
    ...
    @Override
    public EmptyReturn run(PutAllThingsInVisionInSackUseCaseInput input) {
        try {
